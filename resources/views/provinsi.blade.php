...
<div class="container-xl">
    <div class='row'>
        <div class="col-12 col-lg-6 col-md-12">
            ...
            <select class="searchProvinsi form-control" onchange="getDapil(this)" id="searchProvinsi" name="searchProvinsi"></select>
        </div>
...
<script>
    ...
    function getDapil(sel){
            ...
            $('#searchDapil').empty();
            $.ajax({
                url: `https://sirekap-obj-data.kpu.go.id/wilayah/pemilu/pdprdp/${sel.value}.json`,
                dataType: 'json',
                success: function(data) {
                    // Populate options using Chosen.js
                    data.forEach(function(item) {
                    ...
                    getKursiDapil(data[0].nama_dapil);
    ...
    function getSuaraDapil(kode){
        $.ajax({
            url: `https://sirekap-obj-data.kpu.go.id/pemilu/hhcd/pdprdp/${kodeProvinsi}/${kode}.json`,
            dataType: 'json',
            success: function(data) {
    ...
    function getKursiDapil(kode){
        $.ajax({
            url: `{{ URL::to('/') }}/dapil/provinsi/${kode}`,
            dataType: 'json',
            success: function(data) {
                //console.log(data.kursi_dapilprov)
                kursiDapil = data.kursi_dapilprov
